...
const STORY_BEATS: StoryBeat[] = [
    {
        ...
        subtitle: "Turn fragmented EHR, imaging, and omics into simulation-backed, audit-ready decision packs. Support screening, cohort design, and early risk detection—with clinician oversight.",
